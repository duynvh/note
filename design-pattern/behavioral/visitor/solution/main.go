...
func (PrinterVisitor) VisitProduct(p Product) {
	fmt.Printf("Printing product: %s\n", p.Name)
}
func (PrinterVisitor) VisitCategory(c Category) {
	fmt.Printf("Printing category: %s\n", c.Title)
}
func (PrinterVisitor) VisitUser(u User) {
	fmt.Printf("Printing user: %s %s\n", u.FirstName, u.LastName)
}
